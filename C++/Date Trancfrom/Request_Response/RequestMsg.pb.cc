...
static void InitDefaultsscc_info_RespondMsg_RequestMsg_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RespondMsg_RequestMsg_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_RespondMsg_RequestMsg_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_RequestMsg_2eproto[2];
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_RequestMsg_2eproto_sccs[2] = {
  &scc_info_RequestMsg_RequestMsg_2eproto.base,
  &scc_info_RespondMsg_RequestMsg_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_RequestMsg_2eproto = {
  &descriptor_table_RequestMsg_2eproto_initialized, descriptor_table_protodef_RequestMsg_2eproto, "RequestMsg.proto", 219,
  &descriptor_table_RequestMsg_2eproto_once, descriptor_table_RequestMsg_2eproto_sccs, descriptor_table_RequestMsg_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_RequestMsg_2eproto::offsets,
  file_level_metadata_RequestMsg_2eproto, 2, file_level_enum_descriptors_RequestMsg_2eproto, file_level_service_descriptors_RequestMsg_2eproto,
};
...
void RespondMsg::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RespondMsg_RequestMsg_2eproto.base);
  clientid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  serverid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  data_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
